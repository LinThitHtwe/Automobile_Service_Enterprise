...
const HeroSection = () => {
  return (
    <div className="flex h-[30rem] p-10">
      <div className="flex h-full w-full items-center md:w-[50%]">
        <div className="ml-20 mt-14 h-auto">
          ...
          <p className=" p-2 text-lg font-normal tracking-tight text-gray-600">
          ...
          <div className="flex gap-3">
            ...
            <a className="drop-shadow-primary/40 mt-6 block w-[30%] rounded-xl border-2 border-primary/60 px-2 py-3 text-center text-lg font-medium text-primary/90 drop-shadow-lg">
              Email Us
            </a>
          </div>
        </div>
