...
const HeroSection = () => {
  return (
    <>
      <div id="home" className="mt-16 flex h-[73vh] p-10">
        <div className="flex h-full w-full items-center justify-center lg:w-[50%] lg:justify-start">
          <div className="mt-14 h-auto lg:ml-20">
            ...
            <div className="flex justify-center gap-3 lg:justify-start">
              <a
                href="#about"
                className="hero-section-btn drop-shadow-primary/40 bg-primary font-bold  text-white drop-shadow-md hover:bg-[#f6903c]  min-[321px]:w-[38%]  sm:w-[26%] lg:w-[30%]"
              >
                Learn More
              </a>
